...
(async () => {
  ...
  await fs.writeFile("death-by-diseases-of-the-nervous-system-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("death-by-diseases-of-the-nervous-system-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
